...
class TCPDF {
	 ...
	 */
	public function __construct($orientation='', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false) {
	...
	/**
	 * Return true i474n the character is present in the specified font.
